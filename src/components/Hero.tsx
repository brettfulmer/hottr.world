export default function Hero() {
  return (
    <section className="relative min-h-[707px] flex flex-col items-center justify-center px-6 text-center py-20">
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-[#ff3db9] rounded-full blur-[120px]" />
      </div>
      <p className="font-[var(--font-jakarta)] text-[10px] font-bold tracking-[0.3em] uppercase mb-4 text-white/50">
        by HOTTR
      </p>
      <h1 className="font-[var(--font-jakarta)] text-6xl md:text-8xl font-black text-white tracking-tighter mb-4 leading-none">
        DANCE<br />FLOOR
      </h1>
